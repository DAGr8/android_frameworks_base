...
public class LiquidTarget {
    ...
    public final static String TAG = "LiquidTarget";
    ...
    private static LiquidTarget sInstance = null;

    public static LiquidTarget getInstance(Context c) {
        if (sInstance == null) {
            sInstance = new LiquidTarget(c);
        }
        return sInstance;
    }
